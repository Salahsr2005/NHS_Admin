          ...
          <div className="p-6 pt-4">
            ...
            <div className="space-y-0">
              ...
              <CompareRow 
                ...
                renderValue={(v) => v ? <span className="capitalize">{v}</span> : <Minus className="h-4 w-4 text-muted-foreground" />}
              />
              <CompareRow 
                label="Location" 
                values={applications.map((a) => a.applicant?.wilaya)} 
              />
              <CompareRow 
                label="Email" 
              ...
              <CompareRow 
                ...
                renderValue={(edu: any[]) => (
                  <div className="space-y-1">
                    {edu?.length > 0 ? edu.slice(0, 2).map((e, i) => (
              ...
              <CompareRow 
                ...
                renderValue={(exp: any[]) => (
                  <div className="space-y-1">
                    {exp?.length > 0 ? exp.slice(0, 2).map((e, i) => (
                      <div key={i} className="text-xs">
